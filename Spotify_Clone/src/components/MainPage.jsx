...
function MainPage() {
  ...
  function goLib(){
    ...
    sliderRef.current.style.top = '40%'
  }

  function goPlayList(){
    setSlider(prevState => ({ home:false, playlist:true, lib: false }));
    sliderRef.current.style.top = '81%'
    ...
    <>
      <Page>
        ...
        <YourName>Nicollas</YourName>
            ...
            <div style={{width:'100%', display:'flex',justifyContent:'space-between' ,flexDirection:'column', height:'200px',paddingTop:'10px',position:'relative' }}> 
          ...
          <DivMusics>
            <DivTitle> ))) <div style={{marginLeft:'10px'}}></div> <p style={{marginTop:'28px'}}>  SPOTIFY</p></DivTitle>
